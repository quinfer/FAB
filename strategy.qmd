...
A key strategic goal for FAB is to enhance and develop multidisciplinary research through strong links with [CSIT](http://www.csit.qub.ac.uk). The lab is well positioned provide domain knowledge transfer to the BRCD funded Momentum10 institute in Queen's. The following diagram highlights expertise linkages (regulatory technology expertise is highlighted in orange):

```{mermaid}
graph LR
 subgraph F.A.B. within the GII ecosystem
